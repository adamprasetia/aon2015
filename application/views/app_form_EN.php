...
<div class="row">
	...
	<div class="col-md-5">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<?=form_label('1. In what part of the CCA Group do you work ? (Please select one)')?>
				<p>Jawab : <?=form_dropdown('dem_1',$this->mdl_divisi->dropdown('EN'),set_value('dem_1',(isset($row->dem_1)?$row->dem_1:"")))?></p><hr>
				<?=form_label('2. Which of the following best describes your role in this organisation ?')?>
				<p>Jawab : <?=form_dropdown('dem_2',dropnum(5),set_value('dem_2',(isset($row->dem_2)?$row->dem_2:"")))?></p><hr>
				<?=form_label('3. Which of the following best describes your years of service ?')?>
				<p>Jawab : <?=form_dropdown('dem_3',dropnum(9),set_value('dem_3',(isset($row->dem_3)?$row->dem_3:"")))?></p><hr>
				<?=form_label('4. Which of the following best describes your employment status in this organisation ?')?>
